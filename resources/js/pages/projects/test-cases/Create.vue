...
function submit() {
    form.post(route('projects.test-cases.store', props.project.id));
}
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6 max-w-2xl animate-in">
            <h1 class="text-xl font-semibold text-slate-900 mb-6">New Test Case</h1>
            ...
            <form @submit.prevent="submit" class="space-y-5">
                ...
                <div>
                    ...
                    <RichEditor v-model="form.description" placeholder="Describe the test case…" />
                </div>
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <button type="button" @click="addStep"
                            class="px-3 py-2 text-sm text-slate-600 border border-slate-300 rounded-lg hover:bg-slate-50">
                            Add
                        </button>
                    </div>
                </div>
