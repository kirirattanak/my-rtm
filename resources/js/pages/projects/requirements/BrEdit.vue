...
const form = useForm({
    ...
    tags: [...props.br.tags],
    optimistic_hours: props.br.optimistic_hours,
    most_likely_hours: props.br.most_likely_hours,
    pessimistic_hours: props.br.pessimistic_hours,
});

const tagInput = ref('');
const showPert = ref(props.br.optimistic_hours !== null);
